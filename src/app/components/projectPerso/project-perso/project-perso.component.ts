  ...
  template: `
    ...
    >
      <div class="max-w-6xl w-full">
        <h2
          class="text-6xl sm:text-4xl uppercase font-bold font-bodoni text-center mb-16 text-white"
        >
          Projets Personnels
        </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div
            class="bg-gray-800 bg-opacity-10 rounded-xl shadow-lg p-6 animate-slide-in flex flex-col"
          >
...
Elle est construite en Full Stack avec un frontend Angular et un backend Spring Boot, communiquant via une API REST sécurisée par JWT stocké dans des cookies.`,
    ...
    },
    {
      ...
      desc: `Products est une application web conçue pour permettre d'ajouter un produit dans un panier en choisissant les quantités avec un panier reactif. Les datas ne sont pas persistés mais en brut dans le code. Mise en place des principes de séparations entre la business logic et les componsants`,
